  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-28 right-4 md:bottom-6 md:right-6 z-50 px-5 py-3 rounded-full bg-luxury-umber text-white shadow-lg hover:bg-luxury-gold hover:scale-105 transition-all duration-300 flex items-center gap-2 group"
      >
